    ...
    return(
        <div className="card col-sm mx-2 shadow mb-sm-0 mb-2">
                <div className="row">
                    ...
                    <div className="col-12 col-sm-6">
                        <img alt="Cerveza" className="img-fluid imagenesPromo" src="https://media.istockphoto.com/photos/beer-on-a-white-background-picture-id894278766?k=6&m=894278766&s=612x612&w=0&h=5HHeZNtXQy1sNLIBNU54R2_AK496Qq3OIQIK9fSiFgs="></img>
                    </div>
                </div>
        </div>
    )
